...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 02 déc. 2021 à 15:48
...
CREATE TABLE `employes` (
  ...
  `date_embauche` date DEFAULT NULL COMMENT 'date d''embauche de l''employé',
  `salaire` float DEFAULT NULL COMMENT 'rémunération de l''employé'
